...
from topocluster.data.data_modules import MNISTDataModule
from topocluster.models.autoencoder import AutoEncoder, build_conv_autoencoder


def start():
    dm = MNISTDataModule()
    dm.setup()
    encoder, decoder = build_conv_autoencoder(
        input_shape=dm.dims, init_hidden_dims=32, levels=4, latent_dim=100
    )
